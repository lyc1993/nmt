...
for i = 0:numfiles-1
    ...
    abs_s = abs(s);
    abs_s(abs_s==0) = realmin;
    normalize_s = 20*log10(abs_s);
    
    cd 'E:\\Independent Study\\Project\\spectro\\en10000_no0\\data'
...
cd 'E:\\Independent Study\\Project\\spectro\\en10000_no0'
...
for i = 0:numfiles-1
    ...
    cd 'E:\\Independent Study\\Project\\spectro\\zh10000_no0\\data'
...
cd 'E:\\Independent Study\\Project\\spectro\\zh10000_no0'
